...
// //   var listingDiv = document.GetElementById(main)
// // //   var mainDiv = document.createElement("div")
// //   var mainHead = document.createElement("h1")
// //   var mainHeadText = document.createTextNode("Premier League 2015/16")
  

// //  listingDiv.appendChild(mainDiv)
// // listingDiv.appendChild(mainHead)
// // manhead.appendChild(mainHeadText)

// // var heading = document.createElement('h1');
// // var textN = document.createTextNode('Premier League 2015/16');
...
// // var plText1 = document.createTextNode('Match Day 1:');
...
for (var key in rrounds){
  ...
  for  ( var key2 in matches ){
    ...
    var l2iText = document.createTextNode(matches [key2].team1 + "=====> score (" + matches)
    li1.appendChild(li1Text)
    var li2 = document.createElement("li")
    var li1Text = document.createTextNode(matches [key2].team1 + "=====> score (" + matches)
